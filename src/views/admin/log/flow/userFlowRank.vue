    ...
    <div>
        <div>
            ...
            <div style="width: 100%;min-height: 500px;">
                ...
                <div class="log-chart" style="height: 520px;width: 40%;min-width:520px;">
                    <div>
                    ...
                    <div style="min-width:520px;;height: 500px">
...
<script>
    ...
    export default {
        ...
        methods: {
            changeStartTime(e){
                console.log('endtime_start:',e,this.objDate.valEnd,e>this.objDate.valEnd)
            ...
            // 获取用户流量排行的直方图数据
            getUserTrafficRank() {
                trafficRank("userName", this.topValue, this.timeCondition).then(resp => {
                    ...
                    console.log("获取用户流量排行数据出错：", err)
                });
            },
            //获取用户组流量占比
            getUserTrafficPie() {
                trafficRank("userGroup", this.topValue, this.timeCondition).then(resp => {
                    let legend = [];
                    let data = [];
