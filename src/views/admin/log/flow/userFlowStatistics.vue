                ...
                <div class="logForm">
                    <div class="row" style="width:100%">
                        ...
                        <div style="margin-left: -5px">
                            <multipleConditionChoose conditionType="userFlowStatisticLog"></multipleConditionChoose>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="detail-table">
                            <el-table :data="detailData">
                                <el-table-column property="resourceName" label="资源名"
                                                 show-overflow-tooltip></el-table-column>
                                <el-table-column property="uri" label="URL/IP" show-overflow-tooltip></el-table-column>
                                <el-table-column property="uplinkTraffic" label="上行流量(MB)"
                                                 show-overflow-tooltip></el-table-column>
                                <el-table-column property="downlinkTraffic" label="下行流量(MB)"
                                                 show-overflow-tooltip></el-table-column>
                                <el-table-column property="logTimeStamp" label="开始访问时间"
                                                 show-overflow-tooltip></el-table-column>
                                <el-table-column property="logTimeStamp" label="结束访问时间"
                                                 show-overflow-tooltip></el-table-column>
                            </el-table>
                        </div>
                        <div class="row" style="margin-top:8px;">
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                trafficGroupStatics("user", this.condition).then(resp => {
                    ...
                    this.tableData = resp.data.pageDatas.map(item => {
                        return {
                            ...
                            userGroup: item.name2,
                            userGroupHex: item.name2Origin,
                            userName: item.name
                        }
                    });
                }).catch(err => {
            ...
            getDetailList() {
                ...
                // trafficDetails("user", this.detailCondition).then(resp => {
...
<style>
    .user-flow-detail-dialog .el-dialog--small {
