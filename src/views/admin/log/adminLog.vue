                        ...
                        <div class="lob_main">
                            ...
                            <el-row class="list_headers">
                                ...
                                <el-col class="info_input" :span="5">
                                    <el-input clearable v-model="query.userInfo" placeholder="管理员信息"></el-input>
                                </el-col>
                                <el-col class="list_headers_title" :span="2">
                                    <h4>权限</h4>
                                </el-col>
                                <el-col class="info_input" :span="5">
                                    <el-select clearable v-model="query.rightName" placeholder="权限" style="width: 100%;">
                                        <el-option v-for="(item,index) in rightName" :key="index" :value="item" :label="item"></el-option>
                                    </el-select>
                                </el-col>
                                <el-col class="list_headers_title" :span="2">
                                    <h4>源IP</h4>
                            ...
                            <el-row class="list_headers">
                                ...
                                <el-col class="info_input" :span="20">
                                    <el-button class="primary confirm" type="primary" @click="getAdminLogList">查询</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            getRightNameList () {
                ...
                let date = moment(this.query.date).format("YYYY-MM-DD");
                fetch({
                    url: '/es-management/api/search/admin/options/right_name',
                    method: 'post',
                    body: this.setData()
                }).then(res => {
                    if(res.code == 200) {
                        this.rightName = res.data;
                    } else {
            ...
            getOperationList () {
                fetch({
                    url: '/es-management/api/search/admin/options/search_operation_method',
                    method: 'post',
                    body: this.setData()
                }).then(res => {
                    if(res.code == 200) {
            ...
            getAdminLogList (ev, flag) {
                ...
                let endTime = moment(this.query.endTime).format("HH:mm:ss");
                let date = moment(this.query.date).format("YYYY-MM-DD");
                this.getRightNameList();
                this.getOperationList();
                fetch({
                    url: '/es-management/api/search/admin/list',
                    method: 'post',
                    body: {
                        "pageIndex": this.query.current_page,
                        "pageSize": this.query.page_size,
            ...
            generateLog () {
                this.getAdminLogList('event', true);
            }
        }
    }
</script>
