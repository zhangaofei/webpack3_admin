<template>
    <div class="power-form public">
        <el-dialog title="查看权限" :visible.sync="editVisible" top="6%" custom-class="dialog public" size="small" @close="handleClose" @open="doInit(currentData)">
            ...
            <div style="margin-top: 32px">
                <el-form :model="powerForm" ref="powerForm" :rules="rules" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="权限名称" prop="name">
                        <el-input v-model="powerForm.name" class="el_put" placeholder="请输入权限名称" :disabled="true"></el-input>
                    </el-form-item>
                    <el-form-item label="权限说明">
                        <el-input v-model="powerForm.remark" class="el_put" placeholder="请输入权限说明" :disabled="true"></el-input>
                    </el-form-item>

                    <el-form-item label="权限列表" class="item_mark">
                        <div>
                            <!--<div id="e" style="width:450px;float: left;margin-left: 20px;">-->
                    ...
                    <el-form label-width="130px">
                        <el-form-item label="密码基础设置">
                            <div class="text item1" style="">
                                <input type="checkbox" v-model="powerForm.isUserNameEqualPw" :disabled="true">
                                {{'允许用户名密码一致'}}
                            </div>
                            <div class="text item1" style="">
                                <input type="checkbox" v-model="powerForm.isNewPwEqualOldPw" :disabled="true">
                                {{'允许新旧密码一致'}}
                            </div>
                            ...
                            <div style="">
                                ...
                                <div class="el-input" style="width: 64px; margin-left: 10px; margin-right: 10px">
                                    <input class="el-input__inner" style="height: 32px" v-model.number="powerForm.minPwLength"
                                            onafterpaste="this.value=this.value.replace(/\D|^0/g,'')" :disabled="true">
                            ...
                            <div style="margin-top: 15px;">
                                密码组成部分包括
                                <input type="checkbox" style="margin-left: 20px; margin-right: 5px" v-model="powerForm.isNumber" :disabled="true"> 数字
                                <input type="checkbox" style="margin-left: 30px; margin-right: 5px" v-model="powerForm.isLetter" :disabled="true"> 英文字母
                                <input type="checkbox" style="margin-left: 20px; margin-right: 5px" v-model="powerForm.isSpecialSymbol" :disabled="true"> 特殊符号
                            </div>
                        </el-form-item>
        ...
        data() {
            var name = (rule, value, callback) => {
                if(/^[\u4E00-\u9FA5A-Za-z0-9~!@#$%^&*()_+:"<>?{}|\/]{1,20}$/.test(value) == false){
                    callback(new Error("请输入1-20位字母、数字、英文字符、汉字"));
                }else {
                    callback();
                }
            };
...
//                    str = str.replace(']', '')
            ...
            doInit(d) {
                console.log('powerForm',d.name)
                this.powerForm = {id: d.id,
                    name: d.name,
                    remark: d.remark,
                    isDefault:true,
...
//                console.log('初始化editInfo:',this.powerForm)
