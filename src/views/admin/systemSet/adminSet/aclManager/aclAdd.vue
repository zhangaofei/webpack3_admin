<template>
    <div class="web">
        <el-dialog title="新建白名单" :visible.sync="addVisible" @close="handleClose" size="small" custom-class="dialog" top="10%">
            <el-form :model="info" label-width="142px"  class="web-form"
                ...
                <el-form-item label="类型" prop="type">
                    <el-input v-model="whiteType" class="el_put" :disabled="true"></el-input>
                </el-form-item>
