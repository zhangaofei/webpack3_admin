<template>
    <div class="web public">
        <el-dialog
                :title="dialogVisible ? '使用图标库':'编辑系统参数配置'"
            ...
            <el-form :model="info" :rules="rules" v-show="!dialogVisible" label-width="142px" class="config-form" ref="info">
                <el-form-item label="名称" prop="showName" class="item_mark">
                    <span v-if="currentData.canDelete == '1'">
                        <el-input v-model="info.showName" class="el_put" placeholder="名称" ></el-input>
                    </span>
                    <span v-else>
                        <el-input v-model="info.showName" :disabled="true" placeholder="名称" class="el_put"></el-input>
                    </span>
                </el-form-item>
                <el-form-item label="系统参数" prop="value">
                    <el-select v-model="info.value" placeholder="系统参数" class="el_sel" v-if="info.name=='smart_link_support'">
                        <el-option
                ...
                <el-form-item label="描述" prop="">
                    <el-input v-model="info.remark" class="el_put" placeholder="描述" ></el-input>
                </el-form-item>
            </el-form>
            <div class='form-footer ' slot="footer">
                <div  class="foot">
                    <span class="canle" @click="resetForm('info',dialogVisible)">取消</span>
                    <el-button
                            type="primary"
                            class="btn_save"
