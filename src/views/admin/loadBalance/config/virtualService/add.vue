        ...
        <el-dialog
            ...
            <div class="admin-form tab_scroll_div">
                ...
                <el-tabs type="card" v-model="activeName">
                    <el-tab-pane label="基本" name="first">
                        <el-form :model="addInfo" :rules="rules" ref="addInfo" label-width="142px" class="demo-ruleForm">
                            <el-form-item label="名称" prop="">
                                ...
                                <el-input v-model="addInfo.name" placeholder="请输入用户名" class="el_put"></el-input>
                            </el-form-item>
                            <el-form-item label="启用" prop="">
                                <el-checkbox v-model="addInfo.enable" class="checbox_20">启用</el-checkbox>
                            </el-form-item>
                            <el-form-item label="IP地址" prop="">
                                <span style="color: red;position: absolute;left: 12px;">*</span>
                                <!--<el-input v-model="addInfo.ipAddr" class="el_put"></el-input>-->

                                <!--<el-select v-model="addInfo.ipAddr" class="el_sel" placeholder="请选择状态" @change="changeMode(val)">-->
                                    <!--<el-option label="0.0.0.0" value="0.0.0.0"></el-option>-->
                                    <!--<el-option label='+window.location.hostname' value="hostname"></el-option>-->
                                <!--</el-select>-->
                                <el-select v-model="addInfo.ipAddr" class="el_sel" placeholder="">
                                    <el-option
                            ...
                            <el-form-item label="端口" prop="">
                                <span style="color: red;position: absolute;left: 27px;">*</span>
                                <el-input v-model="addInfo.port" class="el_put"
                                          :disabled="(addInfo.moshi=='DR'||addInfo.moshi=='NAT')&&addInfo.mode=='FTP'"></el-input>
                            </el-form-item>
                            <el-form-item label="模式" prop="">
                                <el-select v-model="addInfo.moshi" class="el_sel" placeholder="请选择状态" @change="changeMode(val)">
                            ...
                            <el-form-item label="协议" prop="">
                                <el-select v-model="addInfo.mode" class="el_sel" placeholder="协议"
                                           v-if="addInfo.moshi=='DR'||addInfo.moshi=='NAT'">
                                    <el-option
                                ...
                                <el-select v-model="addInfo.mode" class="el_sel" placeholder="协议" v-else>
                                    <el-option
                            ...
                            <el-form-item label="插入Forwarded" prop="">
                                <el-checkbox v-model="addInfo.forwardFor" class="checbox_20">插入</el-checkbox>
                            </el-form-item>
                            <el-form-item label="内容检查设置" prop="roleName">
                                <el-checkbox v-model="addInfo.contentCheck" class="checbox_20">启用</el-checkbox>
                            </el-form-item>

                            <template v-if="addInfo.contentCheck==true">
                                <el-form-item label="检查类型" prop="">
                                    <span class="dot" style="position: absolute;left: -4px;color: red;">*</span>
                                    <el-select v-model="addInfo.checkType" class="el_sel" placeholder="请选择">
                                        <el-option label="Delay" value="Delay"></el-option>
                                        <el-option label="Length" value="Length"></el-option>
                                    </el-select>
                                </el-form-item>
                                <el-form-item label="时间后检查" prop="">
                                    <el-input v-model="addInfo.checkTime" placeholder="时间后检查" class="el_put"></el-input>
                                </el-form-item>
                            </template>
                            ...
                            <el-form-item label="默认服务池" prop="">
                                ...
                                <el-select v-model="addInfo.defaultBackendId" class="el_sel" placeholder="请选择" @change="pool(addInfo.defaultBackendId)">
                            ...
                            <el-form-item label="服务池路由" v-if="addInfo.moshi=='PROXY'">
                                <span class="dot" style="position: absolute;left: -18px;color: red;">*</span>
                                <el-table
                                        ref="multipleTable"
                                        :data="addInfo.useBackend"
                                        border
                                        tooltip-effect="dark"
                                    ...
                                    >
                                        <template slot-scope="scope">
                                            <!--<el-input v-model="scope.row.serverPoolName" placeholder="服务器池"-->
                                            <!--class="domain"></el-input>-->
                                            <el-select v-model="scope.row.serverPoolId" placeholder="服务器池" class="poolname" ref="poolname" >
                                                <el-option
                                                        v-for="item in serverPoolNames"
                                                        :key="item.id"
                                                        :label="item.name"
                                    ...
                                    <el-table-column
                                        ...
                                        <template slot-scope="scope">
                                            ...
                                            <span v-if="addInfo.useBackend.length>1">
                                                <el-button
                                                        size="small"
                                                        style="border: none;background: transparent;"
                    ...
                    <template v-if="addInfo.moshi=='PROXY'">

                        <el-tab-pane label="SSL终结" name="second" v-if="addInfo.mode=='HTTPS'">
                            <el-form :model="addInfo" :rules="rules" ref="addInfo" label-width="142px"
                                     class="demo-ruleForm">
                                <el-form-item label="SSL版本" prop="">
                                    <!--<el-input v-model="addInfo.ssl.version" placeholder="SSL版本"  class="el_put domain"></el-input>-->
                                    <el-select v-model="addInfo.ssl.version" class="el_sel" placeholder="SSL版本">
                                        <el-option
                                ...
                                <el-form-item label="证书设置" prop="">
                                    ...
                                    <el-input v-model="addInfo.ssl.certificate" placeholder="证书设置" v-if="false"
                                              class="domain el_put"></el-input>
                                    <el-button style="margin-left: 20px" class="primary confirm" type="primary"
                                               @click="trigUpload('cert')">上传证书
                                    </el-button>
                                </el-form-item>
                                <el-form-item label="密钥设置" prop="">
                                    <span style="color: red;position: absolute;left: -4px;">*</span>
                                    <el-input v-model="addInfo.ssl.key" placeholder="密钥设置" v-if="false"
                                              class="domain el_put"></el-input>
                                    <el-button style="margin-left: 20px" class="primary confirm" type="primary"
                                ...
                                <el-form-item label="密钥密码" prop="">
                                    <el-input v-model="addInfo.ssl.keyPassword" placeholder="密钥密码"
                                              class="domain el_put"></el-input>
                                </el-form-item>
                            </el-form>
                        </el-tab-pane>
                        <el-tab-pane label="重定向" name="third" v-if="addInfo.mode=='HTTP'||addInfo.mode=='HTTPS'">
                            <el-form :model="addInfo" :rules="rules" ref="addInfo" label-width="0px"
                                     class="demo-ruleForm">
                                <!--<el-form-item label="启用重定向" prop="" style="">-->
                                <p>
                                    <span>启用重定向</span>
                                    <el-checkbox v-model="addInfo.redirectUse" class="checbox_20">启用</el-checkbox>
                                </p>
                                <!--</el-form-item>-->
                                <template v-if="addInfo.redirectUse==true">
                                    <el-form-item label="">
                                        <!--margin-left:100px;-->
                                        <el-table
                                                ref="multipleTable"
                                                :data="addInfo.redirect"
                                                border
                                                tooltip-effect="dark"
                                                style="max-height: 206px;width: 90%;overflow-y: auto">
                                            <el-table-column
                                                    label="位置"
                                                    align="center"
                                                    width="120"
                                            ...
                                            <el-table-column
                                                ...
                                                <template slot-scope="scope">
                                                    ...
                                                    <span v-if="addInfo.redirect.length>1">
                                                        <el-button
                                                                size="small"
                                                                style="border: none;background: transparent;padding: 4px 7px;"
                        ...
                        <el-tab-pane label="访问控制" name="fourth"
                                     v-if="addInfo.mode=='TCP'||addInfo.mode=='HTTP'||addInfo.mode=='HTTPS'">
                            <el-form :model="addInfo" :rules="rules" ref="addInfo" label-width="142px"
                                     class="demo-ruleForm">
                                <el-form-item label="启用" prop="">
                                    <el-checkbox v-model="addInfo.accessControlUse" class="checbox_20">启用</el-checkbox>
                                </el-form-item>
                                <template v-if="addInfo.accessControlUse==true">
                                    <el-form-item label="tcp">
                                        <el-table
                                                ref="multipleTable"
                                                :data="addInfo.accessControlTCP"
                                                border
                                                tooltip-effect="dark"
                                            ...
                                            <el-table-column
                                                ...
                                                <template slot-scope="scope">
                                                    ...
                                                    <span v-if="addInfo.accessControlTCP.length>1">
                                                        <el-button
                                                                size="small"
                                                                style="border: none;background: transparent;padding: 4px 7px;"
                                    ...
                                    <el-form-item label="阻止">
                                        <el-table
                                                ref="multipleTable"
                                                :data="addInfo.accessControlHTTPBlock"
                                                border
                                                tooltip-effect="dark"
                                                style="max-height: 206px;overflow-y: auto;margin-left: 100px;width: 65%">
                                            <el-table-column
                                            ...
                                            <el-table-column
                                                ...
                                                <template slot-scope="scope">
                                                    ...
                                                    <span v-if="addInfo.accessControlHTTPBlock.length>1">
                                                        <el-button
                                                                size="small"
                                                                style="border: none;background: transparent;padding: 4px 7px;"
                                    ...
                                    <el-form-item label="访问">
                                        <el-table
                                                ref="multipleTable"
                                                :data="addInfo.accessControlHTTPAllow"
                                                border
                                                tooltip-effect="dark"
                                                style="max-height: 206px;overflow-y: auto;margin-left: 100px;width: 65%">
                                            <el-table-column
                                            ...
                                            <el-table-column
                                                ...
                                                <template slot-scope="scope">
                                                    ...
                                                    <span v-if="addInfo.accessControlHTTPAllow.length>1">
                                                        <el-button
                                                                size="small"
                                                                style="border: none;background: transparent;padding: 4px 7px;"
                        ...
                        <el-tab-pane label="反攻击" name="five">
                            <el-form :model="addInfo" :rules="rules" ref="addInfo" label-width="145px"
                                     class="demo-ruleForm">
                                <el-form-item label="启用" prop="">
                                    <el-checkbox v-model="addInfo.counterAttacksUse" class="checbox_20">启用</el-checkbox>
                                </el-form-item>
                                <template v-if="addInfo.counterAttacksUse">
                                    <el-form-item label="最大并发连接数" prop="">
                                        <span style="color:red;position: absolute;left: -48px;">*</span>
                                        <el-input v-model="addInfo.counterAttacks.maxConn" placeholder="最大并发连接数"
                                                  class="el_put"></el-input>
                                    </el-form-item>
                                    <el-form-item label="客户端超时" prop="">
                                        <span style="color:red;position: absolute;left: -19px;">*</span>
                                        <el-input v-model="addInfo.counterAttacks.clientTimeout" placeholder="客户端超时"
                                                  class="el_put"></el-input>
                                    </el-form-item>
                                    <el-form-item label="HTTP超时" prop="">
                                        <span style="color:red;position: absolute;left: -13px;">*</span>
                                        <el-input v-model="addInfo.counterAttacks.httpTimeout" placeholder="HTTP超时"
                                                  class="el_put"></el-input>
                                    </el-form-item>
                                    <el-form-item label="HTTPKeep-alive" prop="">
                                        <span style="color:red;position: absolute;left: -63px;">*</span>
                                        <el-input v-model="addInfo.counterAttacks.httpKeepAliveTimeout" placeholder="HTTPKeep-alive"
                                                  class="el_put"></el-input>
                                    </el-form-item>
                                    <el-form-item label="连接速率限制" prop="">
                                        <el-input v-model="addInfo.counterAttacks.connRateLimit" placeholder="连接速率限制"
                                                  class="el_put"></el-input>
                                    </el-form-item>
                                    <el-form-item label="tarpit超时" prop="">
                                        <el-input v-model="addInfo.counterAttacks.tarpitTimeout" placeholder="tarpit超时"
                                                  class="el_put"></el-input>
                                    </el-form-item>
                                    <el-form-item label="正则表达" prop="">
                                        <el-input
                                                ...
                                                v-model="addInfo.counterAttacks.tarpitRegex">
                                        </el-input>
                                    </el-form-item>
                                </template>
                        ...
                        <el-tab-pane label="重写" name="six" v-if="addInfo.mode=='HTTP'||addInfo.mode=='HTTPS'">
                            <el-form :model="addInfo" :rules="rules" ref="addInfo" label-width="0"
                                     class="demo-ruleForm">
                                <p>
                                    <span>启用重写</span>
                                    <el-checkbox v-model="addInfo.overrideUse" class="checbox_20">启用</el-checkbox>
                                </p>
                                <template v-if="addInfo.overrideUse">

                                    <el-form-item label="">
                                        <el-table
                                                ref="multipleTable"
                                                :data="addInfo.override"
                                                border
                                                tooltip-effect="dark"
                                            ...
                                            <el-table-column
                                                ...
                                                <template slot-scope="scope">
                                                    ...
                                                    <span v-if="addInfo.override.length>1">
                                                        <el-button
                                                                size="small"
                                                                style="border: none;background: transparent;padding: 4px 7px;"
...
<script>
    ...
    import {virtualServiceAdd} from '@/api/loadBalance/virtualService'
    import {getAclList,getAclListNopage} from '@/api/loadBalance/rule'
    import {getServerpoolList,getServerpoolListNopage} from '@/api/loadBalance/servePool'
    ...
    export default {
        ...
        data() {
            return {
                ...
                addInfo: {
                    ...
                    defaultBackendId: '',
                    useBackend: [
                        {serverPoolId: '', aclId: '', condition: 'if'}
                    ],
                    sslUse: false,
                    ...
                    accessControlUse: false,//(要传string)
                    //mode 类型有（tcp,http）
                    accessControlTCP: [
                        {mode: 'TCP', option: 'accept', condition: 'if', aclId: ''}
                    ],
                    accessControlHTTPBlock: [
                        {mode: 'HTTP', option: 'block', condition: 'if', aclId: ''}
                    ],
                    ...
                    override: [
                        {option: 'reqadd', param1: '', param2: '', condition: 'if', aclId: ''}
                    ],
                },
                modeDRorNAT: [
                    {
        ...
        methods: {
            ...
            redirectDel(index, row) {
                this.addInfo.redirect.splice(index, 1)
            },
            // ****useBackendAdd*******************************
            useBackendAdd() {
                this.addInfo.useBackend.push({
                    serverPoolId: '',
                    condition: 'if',
                    aclId: '',
                })
            ...
            useBackendDel(index, row) {
                this.addInfo.useBackend.splice(index, 1)
            },
            // ****accessControl*******************************
            ctrlTcpAdd() {
                this.addInfo.accessControlTCP.push({
                    mode: "TCP",
                    option: "accept",
                    condition: 'if',
                    aclId: '',
            ...
            ctrlTcpDel(index, row) {
                this.addInfo.accessControlTCP.splice(index, 1)
            },

            ctrlBlockAdd() {
                this.addInfo.accessControlHTTPBlock.push({
                    mode: "HTTP",
                    option: "block",
                    condition: 'if',
                    aclId: '',
            ...
            ctrlBlockDel(index, row) {
                this.addInfo.accessControlHTTPBlock.splice(index, 1)
            },

            ctrlHttpAdd() {
                this.addInfo.accessControlHTTPAllow.push({
                    mode: "HTTP",
                    option: "allow",
                    regex: "",
                })
            ...
            ctrlHttpDel(index, row) {
                this.addInfo.accessControlHTTPAllow.splice(index, 1)
            },
            // ****overrideAdd*******************************
            overrideAdd() {
                this.addInfo.override.push({
                    option: "reqadd",
                    param1: "",
                    param2: "",
                    condition: 'if',
            ...
            overrideDel(index, row) {
                this.addInfo.override.splice(index, 1)
            },
            validate() {
                ...
                if(this.addInfo.contentCheck==true){

                    if (this.addInfo.checkType == '') {
                        this.$message({
                            type: 'warning',
                            message: '请选择检查类型！'
                        });
                    ...
                    if (/^[0-9]*$/.test(this.addInfo.checkTime) == false) {
                        this.$message({
                            type: 'warning',
                            message: '时间后检查请输入数字！'
                        });
                ...
                if (this.addInfo.defaultBackendId == '') {
                    this.$message({
                        type: 'warning',
                        message: '默认服务池不能为空！'
                    });
                ...
                if (this.addInfo.moshi == 'PROXY' && this.addInfo.mode == 'HTTPS' && this.addInfo.ssl.certificate == '') {
                    this.$message({
                        type: 'warning',
                        message: '请上传证书设置！'
                    });
                ...
                if (this.addInfo.moshi == 'PROXY' && this.addInfo.mode == 'HTTPS' && this.addInfo.ssl.key == '') {
                    this.$message({
                        type: 'warning',
                        message: '请上传密钥设置！'
                    });
                ...
                // **********重定向*************
                if (this.addInfo.moshi == 'PROXY'&&(this.addInfo.mode == 'HTTPS'||this.addInfo.mode == 'HTTP')&&
                    this.addInfo.redirectUse==true) {
                ...
                //**********访问控制*************
                if (this.addInfo.moshi == 'PROXY'&&(this.addInfo.mode == 'HTTPS'||this.addInfo.mode == 'HTTP'||this.addInfo.mode == 'TCP')&&
                    this.addInfo.accessControlUse==true) {
                ...
                // **********反攻击*************
                // if (this.addInfo.moshi == 'PROXY' && this.addInfo.counterAttacksUse == true && this.addInfo.maxConn == '') {
                //     this.$message({
                //         type: 'warning',
                //         message: '最大并发连接数不能为空！'
                //     });
                //     return false
                // }
                // if (this.addInfo.moshi == 'PROXY' && this.addInfo.counterAttacksUse == true && this.addInfo.clientTimeout == '') {
                //     this.$message({
                //         type: 'warning',
                //         message: '客户端超时不能为空！'
                //     });
                //     return false
                // }
                // if (this.addInfo.moshi == 'PROXY' && this.addInfo.counterAttacksUse == true && this.addInfo.httpTimeout == '') {
                //     this.$message({
                //         type: 'warning',
                //         message: 'HTTP超时不能为空！'
                //     });
                //     return false
                // }
                // if (this.addInfo.moshi == 'PROXY' && this.addInfo.counterAttacksUse == true && this.addInfo.httpKeepAliveTimeout == '') {
                //     this.$message({
                //         type: 'warning',
            ...
            submitForm(formName) {
                ...
                if (this.validate()) {
                    this.addInfo.enable = toStrings(this.addInfo.enable);
                    this.addInfo.sslUse = toStrings(this.addInfo.sslUse);
                    this.addInfo.redirectUse = toStrings(this.addInfo.redirectUse);
                    this.addInfo.forwardFor = toStrings(this.addInfo.forwardFor);
                    this.addInfo.contentCheck = toStrings(this.addInfo.contentCheck);
                    this.addInfo.accessControlUse = toStrings(this.addInfo.accessControlUse);
                    this.addInfo.counterAttacksUse = toStrings(this.addInfo.counterAttacksUse);
                    this.addInfo.overrideUse = toStrings(this.addInfo.overrideUse);
                    virtualServiceAdd(this.addInfo).then((resp) => {
                        console.log('valdata',this.addInfo.forwardFor,this.addInfo.accessControlUse)
                        if (resp.success == true) {
                            ...
                            this.addInfo.enable = toBoolean(this.addInfo.enable);
                            this.addInfo.sslUse = toBoolean(this.addInfo.sslUse);
                            this.addInfo.redirectUse = toBoolean(this.addInfo.redirectUse);
                            this.addInfo.forwardFor = toBoolean(this.addInfo.forwardFor);
                            this.addInfo.contentCheck = toBoolean(this.addInfo.contentCheck);
                            this.addInfo.accessControlUse = toBoolean(this.addInfo.accessControlUse);
                            this.addInfo.counterAttacksUse = toBoolean(this.addInfo.counterAttacksUse);
                            this.addInfo.overrideUse = toBoolean(this.addInfo.overrideUse);
                        }
                    }).catch(e => {
                        console.log("新建出错", e);
                    });
            ...
            uploadSuccess: function (response) {
                if (response.success == true) {
                    ...
                    if (this.currentUpload == "cert") {
                        this.addInfo.ssl.certificate = response.data;
                    } else {
                        this.addInfo.ssl.key = response.data;
                    }
