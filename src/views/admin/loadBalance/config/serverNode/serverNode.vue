...
<script>
    ...
    import {getServernodeList,servernodeDel} from '@/api/loadBalance/serverNode'
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                getServernodeList(this.listQuery).then((resp) => {
                    this.list = resp.data;
