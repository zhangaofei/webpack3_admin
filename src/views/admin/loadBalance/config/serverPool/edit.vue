                    ...
                    <el-tab-pane label="基本" name="first">
                        <el-form :model="editInfo" :rules="rules" ref="editInfo" label-width="142px"
                            ...
                            <el-form-item label="负载均衡算法" prop="">
                                <el-select v-model="editInfo.balance" class="el_sel" placeholder="负载均衡算法">
                                    <el-option
                            ...
                            <el-form-item label="Hash类型" prop="" v-if="editInfo.balance=='SRCHASH'||editInfo.balance=='HDRHASH'||editInfo.balance=='URI'">
                                ...
                                <el-select v-model="editInfo.hashType" class="el_sel" placeholder="Hash类型">
                            ...
                            <template v-if="editInfo.balance=='URI'">
                                <el-form-item label="Uri部分深度" prop="">
                                    ...
                                    <el-input v-model="editInfo.uriDepth" placeholder="Uri部分深度" class="el_put"></el-input>
                                </el-form-item>
                                <el-form-item label="Uri部分长度" prop="">
                                    <span style="color: red;position: absolute;left: -25px;">*</span>
                                    <el-input v-model="editInfo.uriLen" placeholder="Uri部分长度" class="el_put"></el-input>
                                </el-form-item>
                            </template>
                            ...
                            <el-form-item label="头部" prop="" v-if="editInfo.balance=='HDRHASH'">
                                <span style="color: red;position: absolute;left: 27px;">*</span>
                                <el-input v-model="editInfo.hdrName" placeholder="头部" class="el_put"></el-input>
                            </el-form-item>
                            <el-form-item label="选择" prop=""  v-if="false">
                                <el-input v-model="editInfo.serverNodeIds" :disabled="true" placeholder="选择" class="el_put"></el-input>
                            </el-form-item>

                            <el-form-item label="健康检查方法" prop="">
                                <span style="color: red;position: absolute;left: -32px;">*</span>
                                <el-select v-model="editInfo.option" class="el_sel" placeholder="健康检查方法" @change="fun(editInfo.option)">
                                    <el-option
                            ...
                            <el-form-item label="虚拟主机" prop="">
                                <el-input v-model="editInfo.virtualHost" placeholder="虚拟主机" class="el_put"></el-input>
                            </el-form-item>
                            <el-form-item label="间隔" prop="">
                                <span style="color: red;position: absolute;left: 27px;">*</span>
                                <el-input v-model="editInfo.timeoutCheck" placeholder="间隔" class="el_put"></el-input>
                            </el-form-item>
                            <el-form-item label="连接端口" prop="">
                                <span style="color: red;position: absolute;left: -3px;">*</span>
                                <el-input v-model="editInfo.connectPort" placeholder="连接端口" class="el_put"></el-input>
                            </el-form-item>
                            <el-form-item label="绑定IP地址" prop="">
                                <span class="dot" style="position: absolute;left: -18px;color: red;">*</span>
                                <!--<el-select v-model='editInfo.bindIpAddr' class="el_sel" placeholder="绑定IP地址">-->
                                    <!--<el-option label="0.0.0.0" value="0.0.0.0"></el-option>-->
                                    <!--<el-option label="eth4:192.168.20.28" value="192.168.20.28"></el-option>-->
                                <!--</el-select>-->

                                <el-select v-model="editInfo.bindIpAddr" class="el_sel" placeholder="">
                                    <el-option
                            ...
                            <template v-if="editInfo.option=='SSLGET'||editInfo.option=='HTTPGET' ">
                                <el-form-item label="Url" prop="" >
                                    ...
                                    <el-input v-model="editInfo.checkUri" placeholder="Url" class="el_put"></el-input>
                                </el-form-item>
                            </template>
                    ...
                    <el-tab-pane label="超时" name="second">
                        <el-form :model="editInfo" :rules="rules" ref="editInfo" label-width="0px" class="demo-ruleForm">
                            <el-form-item label="连接超时(ms)" prop="">
                                ...
                                <el-input v-model="editInfo.timeoutConnect" placeholder="连接超时" class="el_put"></el-input>
                            </el-form-item>
                            <el-form-item label="队列超时(ms)" prop="">
                                <span style="color: red;position: absolute;left: 98px;">*</span>
                                <el-input v-model="editInfo.timeoutQueue" placeholder="连接超时" class="el_put"></el-input>
                            </el-form-item>
                            <el-form-item label="服务器超时(ms)" prop="">
                                <span style="color: red;position: absolute;left: 84px;">*</span>
                                <el-input v-model="editInfo.timeoutServer" placeholder="服务器超时" class="el_put"></el-input>
                            </el-form-item>
                        </el-form>
                    </el-tab-pane>
                            ...
                            <el-form :model="editInfo" :rules="rules" ref="editInfo" label-width="142px"
                                ...
                                <template v-if="sessionMaintainUse==true">
                                    ...
                                    <span class="checbox_20">
                                        <el-radio v-model="editInfo.mode" label="tcp">tcp</el-radio>
                                        <el-radio v-model="editInfo.mode" label="http">http</el-radio>
                                    </span>
                                    ...
                                    <template v-if="editInfo.mode=='tcp'">
                                        <el-form-item label="过期时间(ms)" prop="">
                                            ...
                                            <el-input v-model="editInfo.tcpExpiration" placeholder="过期时间(ms)" class="el_put"></el-input>
                                        </el-form-item>
                                        <el-form-item label="源码地址掩码" prop="">
                                            <el-input v-model="editInfo.tcpIpAddr" placeholder="源码地址掩码" class="el_put"></el-input>
                                        </el-form-item>
                                    </template>
                                    ...
                                    <template v-else>
                                        ...
                                        <el-form-item label="持久化方法" prop="">
                                            <span class="dot" style="position: absolute;left: -18px;color: red;">*</span>
                                            <el-select v-model='editInfo.sessionMaintainMethod' class="el_sel" placeholder="绑定IP地址">
                                        ...
                                        <template v-if="editInfo.sessionMaintainMethod=='HTTP-Header'">
                                            <el-form-item label="Cookie名称" prop="">
                                                <el-input v-model="editInfo.cookieName" placeholder="服务器超时" class="el_put"></el-input>
                                            </el-form-item>
                                            <el-form-item label="Cookie方法" prop="">
                                                <span class="dot" style="position: absolute;left: -25px;color: red;">*</span>
                                                <el-select v-model='editInfo.cookieMethod' class="el_sel" placeholder="绑定IP地址">
                                        ...
                                        <template v-if="editInfo.sessionMaintainMethod=='HTTP-Header'&&editInfo.cookieMethod=='insert'">
                                            <el-form-item label="透明" prop="">
                                                ...
                                                <el-select v-model='editInfo.cookieIndirect' class="el_sel" placeholder="透明">
                                            ...
                                            <el-form-item label="不用缓存" prop="">
                                                ...
                                                <el-select v-model='editInfo.cookieNocache' class="el_sel" placeholder="不用缓存">
                                                    <el-option label="TRUE" value="TRUE"></el-option>
                                                    <el-option label="FALSE" value="FALSE"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item label="仅Post" prop="">
                                                ...
                                                <el-select v-model='editInfo.cookiePostOnly' class="el_sel" placeholder="仅Post">
                                                    <el-option label="TRUE" value="TRUE"></el-option>
                                                    <el-option label="FALSE" value="FALSE"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item label="域" prop="">
                                                <el-input v-model="editInfo.cookieArea" placeholder="域" class="el_put"></el-input>
                                            </el-form-item>
                                        </template>
                                        ...
                                        <template v-if="editInfo.sessionMaintainMethod=='HTTP-Body'">
                                            <el-form-item label="正则表达式" prop="">
                                                <span class="dot" style="position: absolute;left: -18px;color: red;">*</span>
                                                <el-input v-model="editInfo.regexExp" placeholder="正则表达式" class="el_put"></el-input>
                                            </el-form-item>
                                            <el-form-item label="子表达索引" prop="">
                                                <span class="dot" style="position: absolute;left: -18px;color: red;">*</span>
                                                <el-input v-model="editInfo.regexIndex" placeholder="子表达索引" class="el_put"></el-input>
                                                <!--<el-select v-model='editInfo.regexIndex' class="el_sel" placeholder="子表达索引">-->
                                                    <!--<el-option label="INSERT" value="INSERT"></el-option>-->
                                                <!--</el-select>-->
                                            </el-form-item>
                                            <el-form-item label="等待长度" prop="">
                                                <span class="dot" style="position: absolute;left: -4px;color: red;">*</span>
                                                <el-input v-model="editInfo.regexWaitLength" placeholder="等待长度" class="el_put"></el-input>
                                            </el-form-item>
                                            <el-form-item label="超时(ms)" prop="">
                                                <el-input v-model="editInfo.regexTimeout" placeholder="超时(ms)" class="el_put"></el-input>
                                            </el-form-item>
                                        </template>
    ...
    export default {
        ...
        methods: {
            ...
            validate(){
                ...
                if ((this.editInfo.balance=='HDRHASH')) {
                    if(/^\d+$/.test(this.editInfo.hdrName)==false){
                        this.$message({
                            type: 'warning',
                            message: '头部不能为空！'
                        });
                ...
                if(this.editInfo.option == 'HTTPGET'||this.editInfo.option == 'SSLGET'){
                    if (this.editInfo.checkUri == '') {
                        this.$message({
                            type: 'warning',
                            message: 'Url不能为空！'
                        });
                ...
                if(this.editInfo.option == 'SMTPCHECK'){
                    if (this.editInfo.smtpHeloName == '') {
                        this.$message({
                            type: 'warning',
                            message: '连接IP地址不能为空！'
                        });
                ...
                if (this.editInfo.serverNodeIds == '') {
                    this.$message({
                        type: 'warning',
                        message: '当前选择至少有一个节点！'
                    });
            ...
            submitForm(formName) {
                if (this.validate()) {
                    this.editInfo.sessionMaintainUse=toStrings(this.sessionMaintainUse);
