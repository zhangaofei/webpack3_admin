<template>
    <div class="admin public">
            ...
            <div class="admin-form">
                <el-form :model="editInfo" :rules="rules" ref="editInfo" label-width="142px" class="demo-ruleForm">
                    ...
                    <el-form-item label="描述" prop="">
                        <el-input v-model="editInfo.describe" placeholder="描述" class="el_put"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="操作符" prop="">
                        ...
                        <el-button style="" class="primary confirm" type="primary" @click="addMark">add</el-button>
                    </el-form-item>
                    <el-form-item label="TCP" prop="">
                        ...
                        <el-button style="" class="primary confirm" type="primary" @click="addTcp">add</el-button>
                    </el-form-item>
                    <el-form-item label="HTTP请求行" prop="">
                        ...
                        <el-button style="" class="primary confirm" type="primary" @click="addHttpline">add</el-button>
                    </el-form-item>
                    <el-form-item label="HTTP请求头" prop="">
                        ...
                        <el-button style="" class="primary confirm" type="primary" @click="isHttpHead=true">add</el-button>
                    </el-form-item>
                    <el-form-item label="HTTP请求内容" prop="">
                        ...
                        <el-button style="" class="primary confirm" type="primary" @click="isHttpCont=true">add</el-button>
                    </el-form-item>
                    <el-form-item label="默认ACL" prop="">
                        ...
                        <el-button style="" class="primary confirm" type="primary" @click="isAcl=true">add</el-button>
                    </el-form-item>
                    <el-form-item label="操作内容" prop="">
                        ...
                        <el-button style="" class="primary confirm" type="primary" @click="clearCont">清除</el-button>
                    </el-form-item>
                </el-form>
        ...
        >
            <div class="admin-form">
                <el-form :model="tcpForm" ref="tcpForm" label-width="142px" class="demo-ruleForm">
                    ...
                    <el-form-item label="服务器池" prop="" v-if="tcp=='nbsrv2'">
                        <el-input v-model="tcpForm.header" placeholder="服务器池" class="el_put"></el-input>
                    </el-form-item>
                </el-form>
            </div>
            <div class='form-footer ' slot="footer">
        ...
        >
            ...
            <div class='form-footer ' slot="footer">
                <div class="foot">
                    <span class="cancle btn_middle" @click="reset('aclForm')">取消</span>
                    <el-button
                            class="primary confirm btn_middle"
                            type="primary"
...
<script>
    ...
    import {getAclEdit} from '@/api/loadBalance/rule'
    ...
    export default {
        ...
        methods: {
            ...
            validForm(form){
                if(form=='tcpForm'){
                    // if(/^\d+$/.test(this.tcpForm.param)==false){
            ...
            submitForm(formName) {
                if(this.validate()){
                    getAclEdit(this.editInfo).then((resp) => {
