<template>
    <div>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title" id="res_rdp_title">策略规则</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <!-- 表单搜索框部分 -->
                            ...
                            <el-table
                                ...
                                <el-table-column
                                    ...
                                    <template slot-scope="scope">
                                        ...
                                        <span v-if="scope.row.id=='1'?false:true">
        ...
        <checkPolicy  @onChangeStatus="onChangeStatus" :currentData="currentData" v-if="isLookShow"/>
    </div>
</template>
<script>
    ...
    import {getPolicyList, deletePolicy} from 'api/SSL_VPN/new-policyManager/new-policy';
    import SearchBox from '@/views/components/searchBox.vue';
    export default {
        components: {add, edit, checkPolicy, SearchBox},
        data() {
            return {
                headerCellStyle:{
