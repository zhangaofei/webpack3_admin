    ...
    <div class="radius public">
        ...
        >
            <div style="" class="radius-form">
                <el-form :model="authEditItem" :rules="rules" ref="authEditItem" label-width="130px" class="radius-ruleForm">
                    ...
                    <el-form-item label="RADIUS服务器" prop="authHostOrIp">
                        <el-input v-model="authEditItem.authHostOrIp" placeholder="RADIUS服务器" class="el_put"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="预共享密钥" prop="authSharedSecret">
                        <el-input v-model="authEditItem.authSharedSecret" placeholder="预共享密钥" type="password" class="el_put"></el-input>
                    </el-form-item>

                    <el-form-item label="认证算法" prop="authAlgorithm">
                        <el-select v-model="authEditItem.authAlgorithm" placeholder="认证算法" popper-class="form-auth-select" class="el_sel">
