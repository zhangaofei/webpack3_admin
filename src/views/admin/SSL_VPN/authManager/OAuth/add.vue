        ...
        <el-dialog title="新建OAuth认证"
            ...
            <el-tabs type="border-card">
                <el-tab-pane label="基础参数">
                    <el-form :model="info" label-width="182px" :rules="rules" class="OAuth-form"
                             ref="info">
                ...
                <el-tab-pane label="扩展组参数">
                    <el-form :model="info"  label-width="142px" ref="info" :rules="rules" class="OAuth-form">
                        ...
                        <el-table
                                ...
                                border
                                tooltip-effect="dark"
                                style="width: 75%;max-height: 206px;margin-left:163px;overflow-y: scroll"
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    <el-input v-model="scope.row.external_value" placeholder="请输入扩展组属性" @blur="externalValue(scope.row.external_value)" class="external_value el_put"></el-input>
                                </template>
                            </el-table-column>
                            <el-table-column
