        ...
        data(){
            return {
                ...
                rules: {
                    ...
                    authHostOrIp: [
                        { required: true, message: '请输入LDAP服务器', trigger: 'change' }
                    ],
                    authPort: [
                    ...
                    authDomainName: [
                        { required: true, message: '请输入服务器管理账号', trigger: 'change' }
                    ],
                    ...
                    authDatabaseName: [
                        { required: true, message: '请输入ID 字段名', trigger: 'change' }
                    ],
