        ...
        data(){
            return {
                ...
                rules: {
                    ...
                    authHostOrIp: [
                        { required: true, message: '请输入AD服务器', trigger: 'change' }
                    ],
                    authPort: [
                        { required: true, message: '请输入端口号', trigger: 'change' }
                    ],
                    authBaseDn: [
                        { required: true, message: '请输入BASE DN', trigger: 'change' }
                    ],
                    authDomainName: [
                    ...
                    authPassword: [
                        { required: true, message: '请输入服务器管理口令', trigger: 'change' }
                    ],

                    authUserName: [
                        { required: true, message: '请输服务器管理账号', trigger: 'change' }
                    ],
            ...
            getList(keyword) {
                ...
                authList(this.listQuery.cur_page,
                    ...
                    for (let i = 0; i < this.list.length; i++){
                        let str = this.list[i].authHostOrIp.substring(7, this.list[i].authHostOrIp.length-4);
                        this.list[i].authHostOrIp = str;
                    }
