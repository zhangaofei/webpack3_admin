...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getList(){
                getAllAppsList(this.listQuery).then(response => {
            ...
            getSelectedList(){
                ...
                getSelectedAppsList({groupId:this.groupId}).then(response => {
            ...
            handleSelectionChange(val){
                console.log(val,'val==:',this.selectedList)
                for (let i = 0; i < this.resourceList.length; i++){
                    for (let j = 0; j < this.selectedList.length; j++){
                        if (this.resourceList[i].id == this.selectedList[j].id){
            ...
            sourceSet(formName) {
                ...
                if(fnCount >1){
                    ...
                    updateAppsForGroup(this.groupId, this.selectedList).then(response => {
                        this.addVisible = false;
                        this.$emit("onChangeStatus");
                    }).catch((e) => {
                        console.log(e);
