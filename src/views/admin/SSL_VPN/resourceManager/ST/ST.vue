...
<script>
    ...
    import {delST, getSTList, getPolicies} from "../../../../../api/SSL_VPN/new_resourceManager/new_st";
            ...
            getPolicies(id) {
                getPolicies(id).then((resp)=>{
                    if(resp.status=='SUCCESS'){
                        ...
                        console.log("拼接后的Policy:",this.checkInfo.policiesStr)
