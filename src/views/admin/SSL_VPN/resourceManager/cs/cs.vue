                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Client应用</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <!-- 表单搜索框部分 -->
...
<script>
    ...
    import {delCS, getCSList, getPolicies} from "../../../../../api/SSL_VPN/new_resourceManager/new_cs";
    ...
    export default{
        ...
        methods: {
            ...
            getList(keyword) {
                this.listQuery.searchContent = keyword != undefined ? keyword : this.listQuery.searchContent;
                getCSList(this.listQuery.currentPage,this.listQuery.pageSize,this.listQuery.searchContent).then((resp)=>{
                    this.list=resp.data;
                    for (let i = 0; i < this.list.length; i++){
                        if(this.list[i].ifModify == 1){
                            this.list[i].ifModify = '允许'
                        } else if(this.list[i].ifModify == 0){
                            this.list[i].ifModify = '不允许'
                        }
                    }
