                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="dataTables_length inner_head_left">
                                    <el-button type="success" @click="multipleBindStart()">绑定</el-button>
                                    &nbsp;
                                    <el-button type="danger" @click="multipleUnbindStart()">不绑定并删除</el-button>
...
<script>
    ...
    import {featureCollectListBind} from "@/api/SSL_VPN/hardwareCode/featureCollectList";
    export default{
        components: {
        ...
        methods: {
            ...
            binding(id) {
                let information,successInfo;
                if(this.ifPass=='pass'){
                    information = "确认绑定?";
                    successInfo='绑定成功！';
                }else {
                    information = "确认不绑定并删除?";
                    successInfo='不绑定并删除成功！';
                }
                this.$confirm(information, '提示', {
                    ...
                    featureCollectListBind(id,this.ifPass).then((resp)=> {
