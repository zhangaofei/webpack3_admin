                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="dataTables_length inner_head_left" >
                                    <el-button type="success" @click="multipleAuditStart">审核通过</el-button>
                                    &nbsp;
                                    <el-button type="danger" @click="multipleUnauditStart">审核不通过</el-button>
...
<script>
    ...
    import {featureReview} from "@/api/SSL_VPN/hardwareCode/featureReview";
    export default{
        components: {
            ...
            audit(id) {
               ...
               if(this.ifPass=='pass'){
                ...
                this.$confirm(information, '提示', {
                    ...
                    featureReview(id,this.ifPass).then((resp)=> {
