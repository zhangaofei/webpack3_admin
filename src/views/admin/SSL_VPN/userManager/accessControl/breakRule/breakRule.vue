                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <el-table
                                ...
                                <el-table-column label="匹配规则名称" align="center">
                                    <template slot-scope="scope">{{ scope.row.basics_rule_name }}</template>
                                </el-table-column>
                                <el-table-column label="执行动作" align="center">
                                    <template slot-scope="scope">{{ JSON.parse(scope.row.filter_rule).action }}</template>
                                </el-table-column>
                                <el-table-column label="状态" align="center">
                                    <template slot-scope="scope">
                                        <span v-if="JSON.parse(scope.row.filter_rule).enable ">开启</span>
                                        <span v-else>关闭</span>
                                    </template>
                                </el-table-column>
                                <el-table-column
...
<script>
    ...
    import add from './add'
    import {getBreakRule,delBreakRule} from "@/api/SSL_VPN/accessControl/accessControl";
    ...
    export default{
        ...
        methods: {
            ...
            delete(deleteDTO){
                delBreakRule(deleteDTO).then((resp) => {
                    if (resp.status == 1) {
                        this.$message({
                            type: 'success',
                            message: '删除拦截规则成功！'
