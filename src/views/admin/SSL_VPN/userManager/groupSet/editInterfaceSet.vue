    ...
    <div class="userList-dialog public">
        ...
        >
            ...
            <div class='form-footer ' slot="footer"  >
                <div  class="foot">
                    <span  @click="userReset" class="cancle">取消</span>
                    <el-button
                            type="primary"
...
<script>
    ...
    export default {
        ...
        props:['groupId', 'cancelInterface', 'interfaceCk'],
        created() {
        ...
        methods: {
            handleClose() {
                this.click = true;
                this.$emit("onInterfaceStatus",this.cancelArr, this.click);
            ...
            getUserList(){
                ...
                getApiList(this.userQuery).then(response=>{
                    ...
                    if (this.changePage){
                        if(this.interfaceCk == true){
                            this.allSelectedInterface = this.cancelInterface;
                            this.cancelArr = this.cancelInterface;
                        } else {
                            this.allSelectedInterface = data.usedAipIdList;
                            this.cancelArr = data.usedAipIdList;
                        }
            ...
            userSet(){
                this.click = true;
                this.$emit("onInterfaceStatus",this.allSelectedInterface, this.click)
                this.InfoVisible = false;
            },
            userReset(){
                this.$emit("onInterfaceStatus",this.cancelArr, this.click);
