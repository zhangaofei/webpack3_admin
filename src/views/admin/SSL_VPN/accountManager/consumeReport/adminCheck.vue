<template>
    <div class="admin public">
        <el-dialog title="管理员报表明细" :visible.sync="addVisible" @close="handleClose" size="small" custom-class="dialog" top="10%">
...
<script>
    import {adminReportDetail} from "../../../../../api/SSL_VPN/accountManager/income";
    export default {
        ...
        props:['currentData'],
        created() {
            this.listQuery.adminId = this.currentData.createOperator;
        ...
        methods: {
            ...
            getList(){
                adminReportDetail(this.listQuery).then(response => {
                    if (response.status == 'SUCCESS'){
                        ...
                        console.log('list111:', this.resourceList);
