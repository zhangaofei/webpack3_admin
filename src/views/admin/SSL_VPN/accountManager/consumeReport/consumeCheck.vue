<template>
    <div class="admin public">
        <el-dialog title="交易方式报表明细" :visible.sync="addVisible" @close="handleClose" size="small" custom-class="dialog" top="10%">
            ...
            <div>
                <el-input v-model="chargeWay" style="width: 180px;margin-bottom: 10px" :disabled="true"></el-input>
            </div>
            <el-table
                    ref="multipleTable"
                    :data="resourceList"
...
<script>
    import {chargewayReportDetail} from "../../../../../api/SSL_VPN/accountManager/income";
    export default {
        ...
        props:['currentData'],
        created() {
            this.listQuery.chargeWay = this.currentData.chargeWay;
            ...
            this.chargeWay = '交易方式:  ' + this.currentData.chargeWay;
        },
        methods: {
            search(event){
                if(event.keyCode==13){
            ...
            getList(){
                if(this.listQuery.chargeWay == '现金'){
                    this.listQuery.chargeWay = 1
                } else if(this.listQuery.chargeWay == '微信'){
                    this.listQuery.chargeWay = 2
                } else if(this.listQuery.chargeWay == '支付宝') {
                    this.listQuery.chargeWay = 3
                } else if(this.listQuery.chargeWay == '校园卡') {
                    this.listQuery.chargeWay = 4
                } else if(this.listQuery.chargeWay == '银行转账') {
                    this.listQuery.chargeWay = 5
                }
                chargewayReportDetail(this.listQuery).then(response => {
