            ...
            <div class="">
                <el-form :model="userInfo" :rules="rules" ref="userInfo" label-width="104px" class="demo-ruleForm">
                    <el-form-item label="套餐名称" prop="name">
                        <el-input v-model="userInfo.name" placeholder="请输入套餐名称" :disabled="available()" class="el_put"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="套餐周期" prop="value" class="clearblock">
                        <el-input v-model="userInfo.value" placeholder="请输入套餐周期" :disabled="available()" style="" class="package_put put_left"></el-input>
                        <el-select v-model="userInfo.unit" :disabled="available()" style="" class="put_right" placeholder="请输入套餐单位">
                ...
                if(this.groupIds.length == 0){
                    ...
                    this.$refs[formName].validate((valid) => {
                        if (valid) {
                            ...
                            editPackage(ids, this.userInfo).then(resp => {
