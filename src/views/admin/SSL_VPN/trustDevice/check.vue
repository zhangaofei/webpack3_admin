                    ...
                    <el-table
                        ...
                        >
                            <template slot-scope="scope">
                                <el-select v-model="scope.row.termType" placeholder="请选择" :disabled="true">
                                    <el-option
                        ...
                        <el-table-column
                                ...
                                align="center">
                            <template slot-scope="scope">
                                <el-input v-model="scope.row.hdName"  :disabled="true"></el-input>
                            </template>
                        </el-table-column>
                        <el-table-column
                                label="描述"
                        ...
                        >
                            <template slot-scope="scope">
                                <el-input v-model="scope.row.remark" placeholder="请输入" :disabled="true"></el-input>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-form>
