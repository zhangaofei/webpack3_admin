                ...
                <div class="col-md-12">
                    <div class="box" style="">
                        <div class="box-header">
                            <h3 class="box-title" id="user_set_box_title">用户审核</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <el-row :gutter="30" style="padding: 20px 0 30px;">
                                <el-col :span="6">
                                    <div>
                                        <div class="dataTables_length">
                                            <el-button class="success" type="success" style=" font-weight: bold;" @click="passAction('pass')">审核通过</el-button>
                                            <el-button class="warning" type="danger" style=" font-weight: bold;margin-left: 30px;" @click="passAction('noPass')">审核不通过</el-button>
                                        </div>
                                    </div>
                                </el-col>
                                ...
                                <el-col :span="6" :offset="3" style="float: right; padding: 0 5px;">
                                    <el-date-picker
                                            v-model="date"
                                            type="daterange"
                                            size="small"
...
<script>
    ...
    import {getAuditList, AuditPass} from "../../../../api/SSL_VPN/checkManager/checkConfig";
    ...
    export default{
        ...
        data(){
            return {
                ...
                date:'',
                value: '',
                obj: { selectableRange: '00:00:00 - 24:00:00' }
            }
        },
        created(){
        ...
        methods: {
            ...
            passAction(type){
                if(this.readOnly == true){
                    ...
                    var messageInfo;
                    if(type == 'pass'){
                        messageInfo = '请选择通过审核的用户！'
                    } else {
                        messageInfo = '请选择不通过审核的用户！'
                    }
                    ...
                    AuditPass(passQuery).then(response => {
                        if (response.status == 'SUCCESS') {
                            this.$message({
                                type: 'success',
                                message: '设置成功!'
