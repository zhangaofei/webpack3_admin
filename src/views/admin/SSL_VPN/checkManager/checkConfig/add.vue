        ...
        >
            <div class="user-form">
                <el-form :model="userInfo" :rules="rules" ref="userInfo" label-width="142px" class="demo-ruleForm">
                    ...
                    <template v-if="userInfo.auditType == 'auto'">
                        <el-form-item label="审核规则" prop="auditRule">
                        <el-select v-model="userInfo.auditRule"   placeholder="请选择用户状态" popper-class="form-user-select" class="el_sel">
                            ...
                            <template v-if="userInfo.auditRule == 'rule'">
...
<script>
    ...
    import {addCheckConfig, getGroup} from "../../../../../api/SSL_VPN/checkManager/checkConfig";
    export default{
        components: {
                ...
                if(this.userInfo.groupId == ''){
                    ...
                    this.$refs[formName].validate((valid) => {
                        if (valid) {
                            ...
                            if(this.pass == true){
                                addCheckConfig(this.userInfo).then(resp => {
