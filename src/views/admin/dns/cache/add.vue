            ...
            <div class="admin-form">
                <el-form :model="addInfo" :rules="rules" ref="addInfo" label-width="180px">
                    <el-form-item label="递归策略" prop="strategyid">
                        <el-select v-model="addInfo.strategyid" placeholder="请选择递归策略" class="el_sel">
                            <el-option
                    ...
                    <el-form-item label="TTL" prop="ttl">
                        <el-input v-model="addInfo.ttl" placeholder="请输入TTL值" class="el_put"></el-input>
                    </el-form-item>

                    <el-form-item label="记录类型" prop="recordType">
                        <el-select v-model="addInfo.recordType" placeholder="请选择" class="el_sel_short">
                    ...
                    <el-form-item label="记录值" prop="recordValue">
                        <el-input v-model="addInfo.recordValue" placeholder="请填写" class="el_put"></el-input>
                    </el-form-item>
...
<script>
    ...
    import {addCache} from 'api/enDNS/cache';
    import {getRecursionForPull} from 'api/enDNS/recursion'
    ...
    export default{
        ...
        methods: {
            ...
            getListForSelect(){
                ...
                getRecursionForPull().then(response => {
                    if (response.status == 'SUCCESS'){
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.addInfo.strategyid = this.addInfo.strategyid.toString();
                            addCache(this.addInfo).then((resp) => {
