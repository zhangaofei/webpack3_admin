...
<script>
    ...
    import {getTypeStatic, getServerTime} from 'api/enDNS/cartogram';
    export default {
        props: {
            className: {
                type: String,
        ...
        methods: {
            ...
            getList(){
                getTypeStatic(this.listQuery).then(resp=>{
                    if (resp.status == 'SUCCESS'){
            ...
            initChart() {
                ...
                this.chart.setOption({
                    ...
                    legend: {
                        data:['NS记录','A记录','CNAME记录','SOA记录','PTR记录','TXT记录','AAAA记录']
                    },
                    toolbox: {
                        show : false,
                        feature : {
