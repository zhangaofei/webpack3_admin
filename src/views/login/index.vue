<template>
    <div class="body" style="height: 100%;">
        <div class="nav_down">
            <div>
                <!--<img src="../../assets/login/mod_login_logo.png" alt="">-->
                <ul class="logo_font">
                    <li style="font-size: 25px;color: #fff;">
                        <img src="../../assets/nav/logo_v3.png" alt="v3">
                        <!--<img src="../../assets/nav/login_dz.gif" alt="v3">-->
                        <span>易安联 </span>
                        <span class="spa_third"></span>
                        <span>ENLINK CASB 后台管理系统</span>
                    </li>
                </ul>
            </div>
        ...
        <div class="main">
            <div class="main_one form">
                <p style="">登录</p>
                <form class=" " role="form" autocomplete="off" style="margin-top: 30px">
                    <div class="form-group form_div form_div_put">
                        <!--<span class="user"></span>-->
                        <img src="../../assets/login/user.svg" alt="" class="user">
                        <input type="text" class="log_put " name="userName" autocomplete="off" v-model="loginForm.email" placeholder="请输入名字">
                    </div>
                    <div class="form-group  form_div form_div_put">
                        <!--<span class="psw"></span>-->
                        <img src="../../assets/login/password.svg" alt="" class="psw">
                        <input type="password" class="log_put" name="password" autocomplete="off" v-model="loginForm.password"
                               @keyup.enter="toLogin"
                               placeholder="请输入密码">
                    </div>
                    <div class="form-group form_div" style="border: none;">
                        <button type="button" class="btn" @click="handleLogin" style="outline: 0">登录</button>
                    </div>
                </form>
            </div>
            <!--<span @click="check">滑动验证</span>-->
        </div>
        <div class="footer">
            <span>Copyright ©{{ copyRight }} 江苏易安联网络科技有限公司保留所有权利 </span>
        </div>
        <!--*****************-->
        <div class="">
            <el-dialog
                    ...
                    size="small"
                    custom-class="check_code"
                    :close-on-click-modal="false"
                    :show-close=false
                    top="10%">
                <div class="mail-form">
                    <div class="mv" style="width: 500px;margin: auto;">
                        <!--******************-->
                            <!-- 验证码容器 -->
                ...
                <div class='form-footer ' slot="footer" style="height:50px;" v-if="false">
...
<script>
    ...
    export default{
        ...
        created(){
        console.log('location2',location.href,this.$router.currentRoute.query)
            if(this.$router.currentRoute.query.userName&&this.$router.currentRoute.query.password){
                this.loginForm.email=this.$router.currentRoute.query.userName;
                this.loginForm.password=this.$router.currentRoute.query.password;
                this.handleLogin();
            }
        },
        mounted(){
...
//                this.checkVisible=false
            ...
            handleLogin() {
                this.loading = true;
                console.log(this.$router,'handleLogin')
                if (this.validate()) {
            ...
            validate() {
                if (this.loginForm.email == null || this.loginForm.email.trim() == '') {
                    this.$message({
                        type: 'warning',
                        message: '用户名不能为空！'
                    });
...
<style lang="scss" scoped >
    ...
    .user {
        /*background: url("../../assets/login/new_login_user.png") no-repeat;*/
        position: absolute;
        top: 3px;
        left: 8px;
        width: 30px;
    ...
    .psw {
        /*background: url("../../assets/login/new_login_psw.png") no-repeat;*/
        position: absolute;
        top: 3px;
        left: 8px;
        width: 30px;
    ...
    * {
    ...
    .body {
        height: 100%;
        /*min-height: 100%;*/
        background: url("../../assets/login/new_login_bg.png");
    ...
    .main_one p {
        ...
        height: 69px;
        line-height: 69px;
        border-bottom: 1px solid rgba(242, 228, 255, 0.2);
    }
...
<style lang="scss" >
    .check_code  .el-dialog__header{
        background:#409EFF;
        padding-left: 10px;
    }
    .check_code  .el-dialog__title{
        margin-left: 0;
        color: #fff;
...
<style scoped lang="scss">
    ...
    input:-webkit-autofill{
        /*box-shadow: 0 0 0 17px #3B657B inset !important;*/
